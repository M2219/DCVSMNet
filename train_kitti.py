...
parser.add_argument(
    "--trainlist", default="./filenames/kitti12_15_all.txt", help="training list"
)
parser.add_argument(
    "--testlist", default="./filenames/kitti15_val.txt", help="testing list"
)
...
parser.add_argument(
    "--logdir",
    default="./checkpoints/kitti/test/",
