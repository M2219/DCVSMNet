...
from datasets import KITTI2015loader
from datasets import KITTI2012loader
...
parser.add_argument(
    "--datapath", default="/datasets/kitti_2015/training/", help="data path"
)
...
if args.kitti == "2015":
    all_limg, all_rimg, all_ldisp, test_limg, test_rimg, test_ldisp = (
        KITTI2015loader.kt2015_loader(args.datapath)
    )
else:
    all_limg, all_rimg, all_ldisp, test_limg, test_rimg, test_ldisp = (
        KITTI2012loader.kt2012_loader(args.datapath)
    )
