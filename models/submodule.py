...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride, downsample, pad, dilation):
        ...
        self.conv1 = BasicConv(inplanes, planes, bn=True, relu=True, kernel_size=3, stride=stride, padding=pad, dilation=dilation)
        self.conv2 = BasicConv(planes, planes, bn=True, relu=False, kernel_size=3, stride=1, padding=pad, dilation=dilation)
